...
// MATRIC NO.  : A0191488N
// NUSNET ID   : E0338132
// COMMENTS TO GRADER: I scale the skybox cube and remove translation component
// of the view matrix (from line 325). And I made a change at line 604 to avoid 
// access violation error of glewInit() function.
//============================================================================
...
static void MyDrawFunc(void)
{
	...
	// Scale the skybox cube to the size skyboxSize x skyboxSize x skyboxSize.
	modelMat0 = glm::scale(modelMat0, glm::vec3(skyboxSize));

	// Remove translation component of the view matrix, making it infinitly far.
	glm::mat4 skyboxView = glm::mat4(glm::mat3(viewMat));

	// Compute modelView using skybox view matrix.
    glm::mat4 modelViewMat0 = skyboxView * modelMat0;
